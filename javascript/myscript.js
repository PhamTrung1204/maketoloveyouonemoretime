...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "04/06/2024 gửi đến Trang! Nhịp tim đập:" + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Nhịp tim của Trung như vậy là tại vì:';
document.querySelector('.Description .modal-body').innerHTML = 'Trung sợ mình sẽ hối hận nếu bỏ lỡ Trang trong cuộc đời này. <i class="fas fa-heart"></i> ';
